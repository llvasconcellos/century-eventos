...
function RENDER(sPreloadHTML)
	...
	if(this.IsSecurityRestricted)
		sHTML+="<iframe allowtransparency='yes' security='restricted' style='width:100%;height:100%;margin-top:1px;' src='"+this.scriptPath+"blank.gif'"+
			" name=idContent"+ this.oName + " id=idContent"+this.oName+
			" contentEditable=true></iframe>";//prohibit running ActiveX controls
	else
		sHTML+="<iframe allowtransparency='yes' style='width:100%;height:100%;margin-top:1px;' src='"+this.scriptPath+"blank.gif'"+
			" name=idContent"+ this.oName + " id=idContent"+this.oName+
			" contentEditable=true></iframe>";

	//Paste From Word
	sHTML+="<iframe allowtransparency='yes' style='width:1px;height:1px;overflow:auto;' src='"+this.scriptPath+"blank.gif'"+
		" name=idContentWord"+ this.oName +" id=idContentWord"+ this.oName+
		" contentEditable=true onfocus='"+this.oName+".hide()'></iframe>";

	if(this.css!="")
		{
		document.write("<iframe allowtransparency='yes' id=\"myStyle"+this.oName+"\" name=\"myStyle"+this.oName+"\" src='"+this.scriptPath+"blank.gif' style=\"display:none\"></iframe>");
		}
